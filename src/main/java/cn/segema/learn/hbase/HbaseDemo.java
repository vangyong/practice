...
public class HbaseDemo {
    ...
    public static Connection initHbase() throws IOException {
        ...
        configuration.set(HConstants.ZOOKEEPER_QUORUM, "10.10.143.147");
    ...
    public static void createTable(String tableNmae, String[] cols) throws IOException {
        ...
        if (admin.tableExists(tableName)) {
            ...
            TableDescriptor tableDescriptor = TableDescriptorBuilder.newBuilder(tableName)
                // .setColumnFamily(ColumnFamilyDescriptorBuilder.newBuilder(Bytes.toBytes("base")).build())
                // .setColumnFamily(ColumnFamilyDescriptorBuilder.newBuilder(Bytes.toBytes("address")).build())
