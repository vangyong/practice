...
public class JarLoaderDemo {
    ...
    /**
     * @Description 扫描一个文件夹下面的所有jar，不包含子文件夹和子jar
     * @param directoryPath
     * @return
     ...
     * @throws IOException
     */
    public static Map<String, Class<?>> loadAllJarFromAbsolute(String directoryPath)
    ...
    /**
     * @Description 加载jar包中的类, 扫描指定jar包前需要将这个jar的地址加入了系统类加载器的扫描列表中,<br/>
     *              注意: 这里只支持单个jar的加载，如果这个jar还引入了其他jar依赖， 会加载失败 所以只能用来加载对其他jar包没有依赖的简单对象类
     * @param path
     * @return
     * @throws IOException
     */
     ...
     */
    public static void addUrl(File jarPath)
    ...
    public static void main(String[] args) {
        try {
            Map<String, Class<?>> classes = loadAllJarFromAbsolute("E:\\data\\jar");
