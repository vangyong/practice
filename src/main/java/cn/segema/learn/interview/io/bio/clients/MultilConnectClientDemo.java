...
public class MultilConnectClientDemo {
	...
	public static void socketTest1() {
		try {
			Socket socket = MultilConnectClientDemo.openSocket1();
			String msg = "Contructor socket() test!";
			MultilConnectClientDemo.socketRWTest(socket, msg);
		} catch (Exception e) {
	...
	public static void socketTest2() {
		try {
			Socket socket = MultilConnectClientDemo.openSocket2("127.0.0.1", 9999);
	...
	public static void socketTest3() {
		try {
			Socket socket = MultilConnectClientDemo.openSocket3("127.0.0.1", 9999, 7777);
	...
	public static void main(String[] args) {
		MultilConnectClientDemo.socketTest1();
		MultilConnectClientDemo.socketTest2();
		MultilConnectClientDemo.socketTest3();
	}
}
